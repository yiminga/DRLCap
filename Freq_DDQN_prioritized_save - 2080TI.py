...
os.system("echo JQX_ard_123 | sudo -S nvidia-smi -rgc")
...
MAXS = {'CLOCKS_GPU': 2085, 'UTIL_GPU': 100, 'UTIL_MEM': 100, 'POWER': 260, 'TEMP': 90}
...
gpu_limit = 2085   # GPU core frequency scaling
GPU = range(1635,2100,15)  # action
...
class DQNPrioritizedReplay:
    ...
    def learn(self):
        ...
        self.epsilon -= (INITIAL_EPSILON - FINAL_EPSILON) / 6200
...
for step in range(7000):
    ...
    print('power cap:', gpu_limit)
     # take action
    os.system("echo JQX_ard_123 | sudo -S nvidia-smi -lgc 300,%s" % (gpu_limit))
...
save_path = saver.save(sess, '/home/wym/project/cpu_gpu/RL/net-freq/save_net.ckpt')
print('Save to path: ', save_path)
# 存储神经网络框架
model_path = saver.save(sess, '/home/wym/project/cpu_gpu/RL/net-freq/model')
