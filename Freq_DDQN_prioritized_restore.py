...
# 强化学习 State：(1)GPU频率，(2)GPU利用率，(3)显存利用率，(4)实时功耗，(5)实时温度，(6)当前的power cap
GPU_LABELS = (
               'UTIL_GPU'
              , 'UTIL_MEM'
              , 'POWER'
...
class DQNPrioritizedReplay:
    def __init__(
        ...
        saver.restore(sess, '/home/wym/project/cpu_gpu/gpu/rl/net-freq/save_net.ckpt')
    ...
    def _build_net(self):
        ...
        print('restore model:')
        saver = tf.train.Saver()
        saver.restore(sess, '/home/wym/project/cpu_gpu/gpu/rl/net-freq/model')
...
for step in range(15000):
    ...
    # take action
    # take action
    os.system( "echo JQX_ard_1234 | sudo -S nvidia-smi -lgc 135,%s" %(gpu_limit))
...
# saver = tf.train.Saver()
# save_path = saver.save(sess, '/home/wym/project/cpu_gpu/gpu/rl/net-freq/save_net.ckpt')
# print('Save to path: ', save_path)
# # 存储神经网络框架
# model_path = saver.save(sess, '/home/wym/project/cpu_gpu/gpu/rl/net-freq/model')
