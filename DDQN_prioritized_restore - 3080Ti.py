...
MAXS = {'CLOCKS_GPU': 2130, 'UTIL_GPU': 100, 'UTIL_MEM': 100, 'POWER': 350, 'TEMP': 90}
...
REPLACE_TARGET_ITER = 10000  # 每*次迭代就用输出替代目标函数  500 {50} 50
MEMORY_SIZE = 100  # replay的内存大小                   100 {500} 1000
...
class DQNPrioritizedReplay:
    def __init__(
        ...
        saver.restore(sess, '/home/sjy/project/cpu_gpu/RL/net/save_net.ckpt')
    ...
    def _build_net(self):
        ...
        print('restore model:')
        saver = tf.train.Saver()
        saver.restore(sess, '/home/sjy/project/cpu_gpu/RL/net/model')
...
for step in range(20000):
    ...
    os.system("echo Sjy2022 | sudo -S nvidia-smi -pl %s " % (gpu_limit))  # take action
