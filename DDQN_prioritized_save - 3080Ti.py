...
MEMORY_SIZE = 1000  # replay的内存大小                   100 {500} 1000
...
save_path = saver.save(sess, '/home/sjy/project/cpu_gpu/RL/net/save_net.ckpt')
print('Save to path: ', save_path)
# 存储神经网络框架
model_path = saver.save(sess, '/home/sjy/project/cpu_gpu/RL/net/model')
