...
POWER_IN_STATE = 0  # 是否将功率上限作一种 State
...
for step in range(STEPS):
    ...
    # take action
    os.system("echo / | sudo -S nvidia-smi -pl %s " % (gpu_limit[0]))
...
save_path = saver.save(sess, '/home/wym/project/cpu_gpu/gpu/rl/net/save_net.ckpt')
print('Save to path: ', save_path)
# 存储神经网络框架
model_path = saver.save(sess, '/home/wym/project/cpu_gpu/gpu/rl/net/model')
