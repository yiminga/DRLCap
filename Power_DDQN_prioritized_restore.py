...
def state():
    ...
    gpu_state = np.append(gpu_state, [clock_gpu_bucket[stats['CLOCKS_GPU']]]) # Add SM  frequency index to end of state:
    if POWER_IN_STATE:
...
class DQNPrioritizedReplay:
    def __init__(
        ...
        saver.restore(sess, '/home/wym/project/cpu_gpu/gpu/rl/net-power/save_net.ckpt')
    ...
    def _build_net(self):
        ...
        print('restore model:')
        saver = tf.train.Saver()
        saver.restore(sess, '/home/wym/project/cpu_gpu/gpu/rl/net-power/model')
